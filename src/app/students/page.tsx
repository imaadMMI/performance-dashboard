...
export default function StudentsContent() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <main className="flex-1 px-4 py-6 sm:px-8 sm:py-8 lg:px-12 lg:ml-8 overflow-hidden">
        {/* Header Row - Stack on mobile, grid on desktop */}
        <div className="flex flex-col space-y-4 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0 mb-6 lg:mb-8 items-start mt-8 lg:mt-12">
          {/* Left: Stats */}
          <div className="w-full">
            <h2 className="font-semibold text-xl lg:text-2xl flex flex-wrap items-center gap-4 lg:gap-20 mb-1">
              <span>MOL TP5 2025:</span>
              <span className="flex items-center gap-2 text-black">
                <span className="text-2xl lg:text-3xl font-semibold">79</span>
                <ArrowUp color="green" size={20} />
              </span>
            </h2>
            <p className="text-gray-500 text-sm font-normal">Student intelligence</p>
          </div>

          {/* Center: Change Period */}
          <div className="w-full flex justify-start lg:justify-center">
            <div>
              <button className="inline-flex items-center gap-2 text-gray-600 hover:text-yellow-600 transition-colors font-medium text-sm">
                Change teaching period
                <ChevronDown size={14} />
              </button>
              <hr className="mt-2 w-48 border-gray-300" />
            </div>
          </div>
          ...
          <div className="w-full flex justify-start lg:justify-end">
            <button
              ...
              className="inline-flex items-center gap-1 text-gray-600 hover:text-yellow-600 transition-colors font-medium text-sm"
            >
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 mb-6 lg:mb-8 max-w-7xl">
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 16 16">
              <path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0" />
            </svg>
            <span className="font-semibold text-gray-800">Successful students</span>
          </div>
          ...
          <div className="flex items-center gap-2 opacity-50">
            ...
            <span className="font-semibold text-gray-500">High-risk students</span>
          </div>
        </div>

...
const TriggerMoment: React.FC<TriggerMomentProps> = ({
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="font-sans text-xl">Key trigger moments</h3>
        <p className="text-sm font-sans text-[#868e96]">
      ...
      <div className="bg-white p-6 rounded-lg">
        <div className="flex items-center gap-6 mb-6">
          <button className="px-6 py-3 rounded-lg bg-[#91cdc5] text-white font-sans">
            {category}
          </button>
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <span className="font-sans text-[#868e96] text-lg whitespace-nowrap">
                Customer trigger:
              </span>
